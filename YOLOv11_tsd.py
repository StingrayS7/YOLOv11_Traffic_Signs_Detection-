"""
Используя датасет Traffic Signs Detection дообучим модель YOLO v11 распознавать дорожные знаки в дорожном траффике.
Так же протестируем дообученную модель на видео которое находится  внутри датасета.
---
